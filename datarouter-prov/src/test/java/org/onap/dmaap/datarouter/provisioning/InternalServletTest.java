...
public class InternalServletTest extends DrServletTestBase {
    ...
    @Test
    public void Given_Request_Is_HTTP_GET_With_Halt_In_Endpoint_Then_Request_Succeeds() {
        when(request.getPathInfo()).thenReturn("/halt");
        when(request.isSecure()).thenReturn(false);
    ...
    @Test
    public void Given_Request_Is_HTTP_GET_Starts_With_Logs_In_Endpoint_Then_Request_Succeeds() throws Exception {
    ...
    @Test
    public void Given_Request_Is_HTTP_GET_With_Drlogs_In_Endpoint_Then_Request_Succeeds() throws Exception {
    ...
    @Test
    public void Given_Request_Is_HTTP_POST_To_Logs_Then_Request_Succeeds() throws Exception {
