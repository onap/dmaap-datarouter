...
@PrepareForTest(DRRouteCLI.class)
public class DRRouteCLITest {
    ...
    public void setUp() throws IllegalAccessException{
        ...
        props.setProperty("org.onap.dmaap.datarouter.provserver.truststore.path", "tmp");
        FieldUtils.writeDeclaredStaticField(DB.class, "props", props, true);
    }

    @Test
    public void Given_DRRouteCli_With_No_Server_Then_System_Exit_Failure() throws Exception{
        exit.expectSystemExitWithStatus(1);
        DRRouteCLI.main(new String[]{"add", "ingress", "1", "user1", "172.100.0.0", "node.datarouternew.com"});
    }

    @Test
    public void Given_DRRouteCli_With_Add_Ingress_Then_System_Exit_Success() throws Exception{
        exit.expectSystemExitWithStatus(0);
        mockHttpClientForRestCall();
        PowerMockito.whenNew(DRRouteCLI.class).withArguments("prov.datarouternew.com").thenReturn(drRouteCLI);
        DRRouteCLI.main(new String[]{"-s", "prov.datarouternew.com", "add", "ingress", "1", "user1", "172.100.0.0", "node.datarouternew.com"});
    }
