...
public class LOGJSONObjectTest {
    ...
    @Test
    public void
    Given_Method_Is_NumberToString_And_Number_is_Not_Null_Return_Reformatted_Number_As_String() {
        Number num = 3.0;
    ...
    @Test
    public void
    Given_Method_Is_putOnce_And_KeyValuePair_Does_Not_Exist_In_logJObject_Put_KeyValuePair_Into_logJObject() {
        String val = "value";
        Map<String, Object> map = new HashMap<>();
        LOGJSONObject logJObject = new LOGJSONObject(map);
    ...
    @Test
    public void
    Given_Method_Is_write_And_Length_Of_logJObject_Is_Not_One_Or_Zero_Write_Value_With_New_Indent() {
        Writer writer = new CharArrayWriter();
        Map<String, Object> map = new HashMap<>();
        map.put("key", "value");
        map.put("key1", "value1");
        ...
        assertThat(
            logJObject.write(writer, 3, 1).toString(),
            is("{\n    \"key1\": \"value1\",\n    \"key\": \"value\"\n }"));
    }
}
