...
public class RLEBitSetTest {
  ...
  @Test
  public void Given_Method_Is_Set_And_Value_Is_Not_Range_And_Is_Inside_BitSet_Then_Add_New_Range()
      throws Exception {
    String val = "3";
    RLEBSet.set(2L, 7L);
    RLEBSet.set(val);
  ...
  @Test
  public void Given_Method_Is_Clear_ValueRange_And_Range_Is_Outside_BitSet_Return_Split_BitSets()
      throws Exception {
    long from = 8L;
    long to = 11L;
    RLEBSet.set(2L, 7L);
