...
public class PasswordProcessor {
    ...
    private static final String PASSWORD_ENCRIPTION_STRING = (new DB()).getProperties().getProperty("org.onap.dmaap.datarouter.provserver.passwordencryption");
    private static final char[] PASSWORD = PASSWORD_ENCRIPTION_STRING.toCharArray();
