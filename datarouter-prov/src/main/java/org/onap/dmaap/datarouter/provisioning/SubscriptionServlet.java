...
public class SubscriptionServlet extends ProxyServlet {
    ...
    public void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (message != null) {
            ...
            sendResponseError(resp, HttpServletResponse.SC_FORBIDDEN, message, intlogger);
            return;
        }
        if (isProxyServer()) {
            try {
        ...
        if (bhdr == null) {
            ...
            eventlogger.info(elr);
            sendResponseError(resp, HttpServletResponse.SC_BAD_REQUEST, message, intlogger);
            return;
        }
        ...
        if (sub == null) {
            ...
            eventlogger.info(elr);
            sendResponseError(resp, HttpServletResponse.SC_NOT_FOUND, message, intlogger);
            return;
        }
    ...
    public void doPut(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (!ch.getType().equals(SUB_BASECONTENT_TYPE) || !(ver.equals("1.0") || ver.equals("2.0"))) {
            ...
            eventlogger.info(elr);
            sendResponseError(resp, HttpServletResponse.SC_UNSUPPORTED_MEDIA_TYPE, message, intlogger);
            return;
        }
