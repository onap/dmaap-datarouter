...
public class URLUtilities {
    ...
    private static String getUrlSecurityOption(){
        if(Boolean.parseBoolean(ProvRunner.getProvProperties().getProperty("org.onap.dmaap.datarouter.provserver.tlsenabled", "true")))
            return "https://";
        return "http://";
    }
