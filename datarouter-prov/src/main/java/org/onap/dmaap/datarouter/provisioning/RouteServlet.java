...
public class RouteServlet extends ProxyServlet {
    ...
    private static final String BADURL = "Bad URL.";
    ...
    public void doDelete(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (d == null) {
            sendResponseError(resp, HttpServletResponse.SC_NOT_FOUND, BADURL, eventlogger);
            return;
        }
        boolean rv = true;
        for (Deleteable dd : d) {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (ins == null) {
            sendResponseError(resp, HttpServletResponse.SC_NOT_FOUND, BADURL, intlogger);
            return;
        }
        boolean rv = true;
