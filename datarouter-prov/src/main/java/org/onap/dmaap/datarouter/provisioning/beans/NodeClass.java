...
public abstract class NodeClass extends Syncable {
  ...
  /**
   * Add nodes to the NODES table, when the NODES parameter value is changed. Nodes are only added
   * to the table, they are never deleted.  The node name is normalized to contain the domain (if
   * missing).
   *
