...
//                    try {
//                        //Password encryption changes - Encrypt Feed password in Database
//                        ps2.setString(3, PasswordProcessor.encrypt(fid.getPassword()));
//                    } catch (GeneralSecurityException e) {
//                        intlogger.warn("PROV0005 Feed.doInsert: " + e.getMessage());
//                    }
                    ps2.executeUpdate();
                }
            }
...
//                    try {
//                        //Password encryption changes - Encrypt Feed password in Database
//                        ps.setString(3, PasswordProcessor.encrypt(fid.getPassword()));
//                    } catch (GeneralSecurityException e) {
//                        intlogger.warn("PROV0006 Feed.doUpdate: "+e.getMessage());
//                    }
                    ps.executeUpdate();
                }
            }
...
//                        ps.setString(3, PasswordProcessor.encrypt(fid.getPassword()));
//                    } catch (GeneralSecurityException e) {
//                        intlogger.warn("PROV0999 Feed.doUpdate: "+e.getMessage());
//                    }
                    ps.executeUpdate();
                }
            }
