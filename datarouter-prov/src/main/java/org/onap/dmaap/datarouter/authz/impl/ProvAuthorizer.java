...
public class ProvAuthorizer implements Authorizer {
    ...
    private static final String SUBJECT_HEADER = "X-DR-ON-BEHALF-OF";  // HTTP header carrying requester identity
    private static final String SUBJECT_HEADER_GROUP = "X-DR-ON-BEHALF-OF-GROUP";  // HTTP header carrying requester identity  by group Rally : US708115
