...
//            try {
//                //Password encryption changes - Encrypt subscriber password in Database
//                ps.setString(5, PasswordProcessor.encrypt(getDelivery().getPassword()));
//            } catch (GeneralSecurityException e) {
//                intlogger.warn("PROV0005 Subscription.doInsert: "+e.getMessage());
//            }
...
//            try {
//                //Password encryption changes - Encrypt subscriber password in Database
//                ps.setString(3, PasswordProcessor.encrypt(delivery.getPassword()));
//            } catch (GeneralSecurityException e) {
//                intlogger.warn("PROV0006 Subscription.doUpdate: "+e.getMessage());
//            }
