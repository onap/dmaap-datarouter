...
public class BaseServlet extends HttpServlet implements ProvDataProvider {
    ...
    public static final Marker EXIT = MarkerFactory.getMarker("ENTRY");
    ...
    void setIpFqdnRequestIDandInvocationIDForEelf(String method, HttpServletRequest req) {
        ...
        setRequestIdOrInvocationId(req, "X-ONAP-RequestID", MDC_KEY_REQUEST_ID);
        setRequestIdOrInvocationId(req, "X-InvocationID", "InvocationId");

    }

    void setRequestIdOrInvocationId(HttpServletRequest req, String headerName, String KeyName)
    {
