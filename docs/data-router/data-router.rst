...
curl -v -X DELETE -H "X-ATT-DR-ON-BEHALF-OF: {user}" --location-trusted -k https:/{hostname}:{port}/feed/{feedId}
...
curl -v -X DELETE -H "X-ATT-DR-ON-BEHALF-OF: {user}" --location-trusted -k https:/{hostname}:{port}/subscribe/{feedId}
...
curl -v -X DELETE -H "X-ATT-DR-ON-BEHALF-OF: {user}" --location-trusted -k https:/{hostname}:{port}/publish/{feedId}/{fileId}
