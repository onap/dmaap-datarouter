...
public interface DeliveryQueueHelper {
     ...
     */
    String getDestURL(DestInfo dest, String fileid);
     ...
     */
    void handleUnreachable(DestInfo dest);
     ...
     */
    boolean handleRedirection(DestInfo dest, String location, String fileid);
