...
public class DestInfo {
     ...
     */
    public DestInfo(String name, String spool, String subid, String logdata, String url, String authuser, String authentication, boolean metaonly, boolean use100, boolean waitForFileProcessed) {
        this.name = name;
        this.spool = spool;
        this.subid = subid;
