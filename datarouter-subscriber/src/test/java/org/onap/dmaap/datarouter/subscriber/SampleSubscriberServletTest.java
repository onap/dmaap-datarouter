...
public class SampleSubscriberServletTest {
    ...
    @Before
    public void setUp() {
        props = SubscriberProps.getInstance(
                System.getProperty("org.onap.dmaap.datarouter.subscriber.properties", "testsubscriber.properties"));
    ...
    public void tearDown() {
        try {
            FileUtils.deleteDirectory(new File(props.getValue("org.onap.dmaap.datarouter.subscriber.delivery.dir")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void Given_Request_Is_HTTP_PUT_And_Request_Header_Is_Null_Then_Unathorized_Response_Is_Generated() {
    ...
    @Test
    public void Given_Request_Is_HTTP_PUT_And_Request_Header_Is_Not_Authorized_Then_Forbidden_Response_Is_Generated() {
...
//    @Test
//    public void Given_Request_Is_HTTP_PUT() {
